...
Adds jQuery QapTcha functionality to your forms.
When QapTcha is unlocked, next request has to 
submit form. Otherwise QapTcha is locked back.
...
an example you find in L<https://github.com/hrupprecht/Mojolicious-Plugin-Qaptcha/blob/master/ex/qaptcha.pl|ex/qaptcha.pl>
